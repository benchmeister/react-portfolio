...
export default class AboutMenu extends Component {
  ...
  constructor(props) { // create initial state - this is how we starting the page, keep track of changes
    super(props);
    this.state = {
    activeMenuItem: 1, // always start on the first menu item, first subheading
    activeSubheading: 1,
    };
  ...
  render() {
    ...
    const activeMenuTitle = menuItems[activeMenuItem - 1]; // array, hence to get first index, go to zero index
    const activeMenuIcon = 
      activeMenuTitle === "PERSONAL" ? personalIcon : activeMenuTitle
      === "EDUCATION" ? educationIcon : careerIcon; // basically this is a if-else statement
